...
show_planned_actions() {
    ...
    printf "+------------------------------------------+\n"
    printf "| %-40s |\n" "DIRECTORY STRUCTURE:"
    printf "| %-40s |\n" "✓ Create .claude/ commands & agents"
    printf "| %-40s |\n" "✓ Create .aipex/ organized container"
    printf "| %-40s |\n" "✓ Setup .aipex/templates/ for modularity"
    printf "| %-40s |\n" ""
    printf "| %-40s |\n" "CLAUDE COMMANDS:"
    printf "| %-40s |\n" "✓ Install 7 enhanced Claude commands"
    printf "| %-40s |\n" "✓ Setup multi-agent validation system"
    printf "| %-40s |\n" ""
    printf "| %-40s |\n" "FEATURES:"
    printf "| %-40s |\n" "✓ Ticket-based PRP naming"
